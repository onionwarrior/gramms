...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    {
      // monom
      char dummy1[sizeof (Monom)];

      // polynomial
      char dummy2[sizeof (Polynomial)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_file_cont = 13,                        // file_cont
        S_polynomial = 14,                       // polynomial
        S_monom = 15                             // monom
      };
    };
        ...
        switch (this->kind ())
    {
      case symbol_kind::S_monom: // monom
        value.move< Monom > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Monom&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Monom& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Polynomial&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Polynomial& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    ...
    , location (that.location)
  {
    ...
    {
      case symbol_kind::S_monom: // monom
        value.copy< Monom > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case symbol_kind::S_monom: // monom
        value.move< Monom > (YY_MOVE (s.value));
        break;
