...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_BASIC (char v, location_type l)
      {
        return symbol_type (token::TOK_BASIC, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_BASIC (const char& v, const location_type& l)
      {
        return symbol_type (token::TOK_BASIC, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_DECL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_DECL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
